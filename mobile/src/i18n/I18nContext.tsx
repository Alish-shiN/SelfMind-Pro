...
const en = {
  ...
  onlyFriendsCanMessage: "Only friends can send me messages",
  onlyFriendsCanMessageDesc: "When enabled, non-friends cannot start direct messages.",
  privateAccountNotice: "This account is private",
  onlyPublicCommunityInfo: "Only public community information is visible",
  anonymousPost: "Anonymous post",
  anonymousAuthorStayed: "The author chose to stay anonymous for this post.",
  ...
  moodCheckInReminder: "Mood check-in reminder",
  aiSelfCheckReminder: "AI self-check reminder",
  ...
  tapToOpenConversation: "Tap to open conversation",
  directMessages: "Direct messages",
  aiChatSessions: "AI chat sessions",
  writeAMessage: "Write a message...",
  send: "Send",
  startFirstConversation: "Start your first conversation",
  aiChatSessionsWillAppear: "Your AI chat sessions will appear here.",
  ...
  achievementMadeOneFriend: "Made 1 friend",
  achievementMadeOneFriendDesc: "You connected with your first friend.",
  achievementMadeThreeFriends: "Made 3 friends",
  achievementMadeThreeFriendsDesc: "You built a small support circle.",
  achievementMessagedOnePerson: "Messaged 1 person",
  achievementMessagedOnePersonDesc: "You started your first direct conversation.",
  achievementMessagedFivePeople: "Messaged 5 people",
  achievementMessagedFivePeopleDesc: "You reached out to five different people.",
  ...
  offlineShowingSavedData: "You're offline. Showing saved data.",
  savedOfflineWillSync: "Saved offline. It will sync when you're back online.",
  connectionSlowShowingSavedData: "Connection is slow. Showing saved data.",
  pendingSync: "Pending sync",
  onlineRequired: "Connection required",
  featureRequiresConnection:
    "This feature requires connection. You can view previous quiz results offline.",
  syncFailedWillRetry: "Sync failed. It will retry later.",
  ...
  resetPasswordMessage: "Enter your email and we will send a reset link.",
  resetPasswordEmailSent: "Password reset email sent.",
  verifyEmailTitle: "Verify your email",
  verifyEmailMessage: "Verification email sent. Please verify before signing in.",
  resendVerificationEmail: "Resend verification email",
  verificationEmailSent: "Verification email sent.",
  pleaseVerifyEmailBeforeLogin: "Please verify your email before login.",
  showPassword: "Show password",
  hidePassword: "Hide password",
  invalidEmailOrPassword: "Invalid email or password",
  emailAlreadyInUse: "Email already in use",
  firebaseAuthErrorGeneric: "Authentication error. Please try again.",
  backendAccountSyncProblem: "Backend account sync problem. Please contact support.",
...
const ru: Record<keyof typeof en, string> = {
  ...
  onlyFriendsCanMessage: "Только друзья могут отправлять мне сообщения",
  onlyFriendsCanMessageDesc: "Если включено, не-друзья не смогут начать личную переписку.",
  privateAccountNotice: "Этот аккаунт приватный",
  onlyPublicCommunityInfo: "Видна только публичная информация сообщества",
  anonymousPost: "Анонимный пост",
  anonymousAuthorStayed: "Автор решил остаться анонимным для этого поста.",
  cannotMessageUser: "Вы не можете написать этому пользователю",
  achievementMadeOneFriend: "Добавлен 1 друг",
  achievementMadeOneFriendDesc: "Вы нашли первого друга в сообществе.",
  achievementMadeThreeFriends: "Добавлено 3 друга",
  achievementMadeThreeFriendsDesc: "Вы собрали небольшой круг поддержки.",
  achievementMessagedOnePerson: "Написали 1 человеку",
  achievementMessagedOnePersonDesc: "Вы начали первый личный диалог.",
  achievementMessagedFivePeople: "Написали 5 людям",
  achievementMessagedFivePeopleDesc: "Вы пообщались с пятью разными людьми.",
  language: "Язык",
  english: "Английский",
  russian: "Русский",
  kazakh: "Казахский",
  ...
  sortPosts: "Сортировка постов",
  accountInformation: "Информация аккаунта",
  country: "Страна",
  aboutMe: "О себе",
  selectBirthDate: "Выберите дату рождения",
  birthDateCannotBeFuture: "Дата рождения не может быть в будущем",
  dailyJournalReminder: "Ежедневный дневник",
  moodCheckInReminder: "Напоминание о настроении",
  aiSelfCheckReminder: "Напоминание AI self-check",
  ...
  tapToOpenConversation: "Нажмите, чтобы открыть разговор",
  directMessages: "Личные сообщения",
  aiChatSessions: "Сессии AI-чата",
  writeAMessage: "Напишите сообщение...",
  send: "Отправить",
  startFirstConversation: "Начните свой первый разговор",
  aiChatSessionsWillAppear: "Здесь появятся ваши сессии AI-чата.",
  ...
  offlineShowingSavedData: "Вы офлайн. Показываем сохраненные данные.",
  savedOfflineWillSync:
    "Сохранено офлайн. Синхронизируется, когда вы снова будете онлайн.",
  connectionSlowShowingSavedData:
    "Соединение медленное. Показываем сохраненные данные.",
  pendingSync: "Ожидает синхронизации",
  onlineRequired: "Нужно подключение",
  featureRequiresConnection:
    "Эта функция требует подключения. Оффлайн можно смотреть прошлые результаты опросов.",
  syncFailedWillRetry: "Синхронизация не удалась. Повторим позже.",
...
const kk: Record<keyof typeof en, string> = {
  ...
  message: "Хабарлама",
  privateAccount: "Жеке аккаунт",
  onlyFriendsCanMessage: "Маған тек достар хабарлама жібере алады",
  onlyFriendsCanMessageDesc: "Қосулы болса, дос емес адамдар жеке хатты бастай алмайды.",
  privateAccountNotice: "Бұл аккаунт жеке",
  onlyPublicCommunityInfo: "Тек қауымдастықтағы ашық ақпарат көрсетіледі",
  anonymousPost: "Анонимді жазба",
  anonymousAuthorStayed: "Автор бұл жазбада анонимді болуды таңдады.",
  cannotMessageUser: "Бұл пайдаланушыға жаза алмайсыз",
  achievementMadeOneFriend: "1 дос қосты",
  achievementMadeOneFriendDesc: "Қауымдастықта алғашқы досыңызды қостыңыз.",
  achievementMadeThreeFriends: "3 дос қосты",
  achievementMadeThreeFriendsDesc: "Кішкентай қолдау шеңберін құрдыңыз.",
  achievementMessagedOnePerson: "1 адамға жазды",
  achievementMessagedOnePersonDesc: "Алғашқы жеке сөйлесуді бастадыңыз.",
  achievementMessagedFivePeople: "5 адамға жазды",
  achievementMessagedFivePeopleDesc: "Бес түрлі адамға хабарластңыз.",
  language: "Тіл",
  english: "Ағылшын",
  russian: "Орыс",
  kazakh: "Қазақ",
  ...
  sortPosts: "Жазбаларды сұрыптау",
  accountInformation: "Аккаунт ақпараты",
  country: "Ел",
  aboutMe: "Мен туралы",
  selectBirthDate: "Туған күнді таңдаңыз",
  birthDateCannotBeFuture: "Туған күн болашақта болмауы керек",
  dailyJournalReminder: "Күнделікті күнделік еске салуы",
  moodCheckInReminder: "Көңіл-күйді тексеру еске салуы",
  aiSelfCheckReminder: "AI self-check еске салуы",
  newMessage: "Жаңа хабарлама",
  youHaveNewMessage: "Сізде жаңа хабарлама бар",
  oldest: "ескі",
  ...
  noMessagesYet: "Хабарламалар әлі жоқ",
  tapToOpenConversation: "Сөйлесуді ашу үшін басыңыз",
  directMessages: "Жеке хабарламалар",
  aiChatSessions: "AI чат сессиялары",
  writeAMessage: "Хабарлама жазыңыз...",
  send: "Жіберу",
  startFirstConversation: "Алғашқы сөйлесуді бастаңыз",
  aiChatSessionsWillAppear: "AI чат сессияларыңыз осында көрінеді.",
  ...
  offlineShowingSavedData: "Сіз офлайнсыз. Сақталған деректер көрсетілуде.",
  savedOfflineWillSync:
    "Офлайн сақталды. Интернетке қосылғанда синхрондалады.",
  connectionSlowShowingSavedData:
    "Байланыс баяу. Сақталған деректер көрсетілуде.",
  pendingSync: "Синхрондау күтілуде",
  onlineRequired: "Интернет қажет",
  featureRequiresConnection:
    "Бұл функцияға интернет қажет. Офлайн режимде алдыңғы сауалнама нәтижелерін көре аласыз.",
  syncFailedWillRetry: "Синхрондау сәтсіз болды. Кейін қайта тырысамыз.",
